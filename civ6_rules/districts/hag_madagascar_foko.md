# Foko (`DISTRICT_HAG_MADAGASCAR_FOKO`)

> **คำอธิบายในเกม:**  
> A district unique to Madagascar replacing Neighborhood.

---

## 1. ข้อมูลพื้นฐานและการปลดล็อก (Basic Information & Unlocking)

- **DistrictType**: `DISTRICT_HAG_MADAGASCAR_FOKO`
- **ชื่อภาษาอังกฤษ (Name)**: Foko
- **ประเภทเขต (District Category)**: Non-Specialty District (ไม่จำกัดโควตา Pop / สร้างได้อิสระ)
- **แทนที่เขตมาตรฐาน (Replaces)**: `DISTRICT_NEIGHBORHOOD` (Neighborhood)
- **อารยธรรม / ผู้นำเฉพาะ (Exclusive to)**: LOC_CIVILIZATION_HAG_MADAGASCAR_NAME (`TRAIT_DISTRICT_HAG_MADAGASCAR_FOKO`)
- **เทคโนโลยีที่ต้องการ (PrereqTech)**: None (ไม่มี)
- **วัฒนธรรมที่ต้องการ (PrereqCivic)**: Craftsmanship (`CIVIC_CRAFTSMANSHIP`)
...
|---|---|---|---|---|
| Production | `+1` | เขต Aqueduct | `DISTRICT_AQUEDUCT` | `HAG_Foko_Aqueduct_Production1` |
| Production | `+2` | เขต Aqueduct | `DISTRICT_AQUEDUCT` | `HAG_Foko_Aqueduct_Production2` |
| Production | `+1` | เขต Canal | `DISTRICT_CANAL` | `HAG_Foko_Canal_Production1` |
| Production | `+2` | เขต Canal | `DISTRICT_CANAL` | `HAG_Foko_Canal_Production2` |
| Food | `+1 ต่อ 2 ช่อง` | สิ่งปรับปรุง Farm | `IMPROVEMENT_FARM` | `HAG_Foko_Farm_Food1` |
| Food | `+1` | สิ่งปรับปรุง Farm | `IMPROVEMENT_FARM` | `HAG_Foko_Farm_Food2` |
| Gold | `+1` | สิ่งปรับปรุง Plantation | `IMPROVEMENT_PLANTATION` | `HAG_Foko_Plantation_Gold1` |
| Gold | `+2` | สิ่งปรับปรุง Plantation | `IMPROVEMENT_PLANTATION` | `HAG_Foko_Plantation_Gold2` |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Foko (DISTRICT_HAG_MADAGASCAR_FOKO)
function IsValidPlotFor_DISTRICT_HAG_MADAGASCAR_FOKO(pPlayer, pPlot, pCity)
