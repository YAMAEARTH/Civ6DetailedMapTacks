...
- **ชื่อภาษาอังกฤษ (Name)**: Lavra
- **ประเภทเขต (District Category)**: Specialty District (นับโควตาประชากรเมือง Pop 1, 4, 7, 10...)
- **แทนที่เขตมาตรฐาน (Replaces)**: `DISTRICT_HOLY_SITE` (Holy Site)
- **อารยธรรม / ผู้นำเฉพาะ (Exclusive to)**: Russia (`TRAIT_CIVILIZATION_DISTRICT_LAVRA`)
- **เทคโนโลยีที่ต้องการ (PrereqTech)**: Astrology (`TECH_ASTROLOGY`)
...
|---|---|---|---|---|
| Faith | `+1 ต่อ 2 ช่อง` | เขตใดๆ (Any District) | `DISTRICT_ALL` | `District_Faith` |
| Faith | `+1 ต่อ 2 ช่อง` | ฟีเจอร์ Woods | `FEATURE_FOREST` | `Forest_Faith` |
| Faith | `+1` | เขต Government Plaza | `DISTRICT_GOVERNMENT` | `Government_Faith` |
| Faith | `+1` | ภูมิประเทศ Grassland (Mountain) | `TERRAIN_GRASS_MOUNTAIN` | `Mountain_Faith1` |
| Faith | `+1` | ภูมิประเทศ Plains (Mountain) | `TERRAIN_PLAINS_MOUNTAIN` | `Mountain_Faith2` |
| Faith | `+1` | ภูมิประเทศ Desert (Mountain) | `TERRAIN_DESERT_MOUNTAIN` | `Mountain_Faith3` |
| Faith | `+1` | ภูมิประเทศ Tundra (Mountain) | `TERRAIN_TUNDRA_MOUNTAIN` | `Mountain_Faith4` |
| Faith | `+1` | ภูมิประเทศ Snow (Mountain) | `TERRAIN_SNOW_MOUNTAIN` | `Mountain_Faith5` |
| Faith | `+2` | สิ่งมหัศจรรย์ธรรมชาติ (Natural Wonder) | `NATURAL_WONDER` | `NaturalWonder_Faith` |
| Faith | `+1` | ฟีเจอร์ Pamukkale | `FEATURE_PAMUKKALE` | `Pamukkale_Faith` |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Lavra (DISTRICT_LAVRA)
function IsValidPlotFor_DISTRICT_LAVRA(pPlayer, pPlot, pCity)
