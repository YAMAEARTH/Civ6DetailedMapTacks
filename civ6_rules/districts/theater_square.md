# Theater Square (`DISTRICT_THEATER`)
...
- **ชื่อภาษาอังกฤษ (Name)**: Theater Square
...
|---|---|---|---|---|
| Culture | `+2` | เขต Copacabana | `DISTRICT_WATER_STREET_CARNIVAL` | `Copacabana_Culture` |
| Culture | `+1 ต่อ 2 ช่อง` | เขตใดๆ (Any District) | `DISTRICT_ALL` | `District_Culture` |
...
| Culture | `+2` | เขต Hippodrome | `DISTRICT_HIPPODROME` | `Hippodrome_Culture` |
| Culture | `+2` | ฟีเจอร์ Pamukkale | `FEATURE_PAMUKKALE` | `Pamukkale_Culture` |
| Culture | `+2` | เขต Street Carnival | `DISTRICT_STREET_CARNIVAL` | `StreetCarnival_Culture` |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Theater Square (DISTRICT_THEATER)
function IsValidPlotFor_DISTRICT_THEATER(pPlayer, pPlot, pCity)
