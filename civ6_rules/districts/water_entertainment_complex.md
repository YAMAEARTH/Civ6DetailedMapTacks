# Water Park (`DISTRICT_WATER_ENTERTAINMENT_COMPLEX`)

> **คำอธิบายในเกม:**  
> A district placed out on a coastal tile dedicated to keeping your people happy by increasing [ICON_Amenities] Amenities. Cannot be built in a city with an Entertainment Complex. Cannot be built on Reef.

---

## 1. ข้อมูลพื้นฐานและการปลดล็อก (Basic Information & Unlocking)

- **DistrictType**: `DISTRICT_WATER_ENTERTAINMENT_COMPLEX`
- **ชื่อภาษาอังกฤษ (Name)**: Water Park
...
- **วัฒนธรรมที่ต้องการ (PrereqCivic)**: Natural History (`CIVIC_NATURAL_HISTORY`)
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Water Park (DISTRICT_WATER_ENTERTAINMENT_COMPLEX)
function IsValidPlotFor_DISTRICT_WATER_ENTERTAINMENT_COMPLEX(pPlayer, pPlot, pCity)
