# Floating Market (`DISTRICT_SUK_FLOATINGMARKET`)
...
- **DistrictType**: `DISTRICT_SUK_FLOATINGMARKET`
- **ชื่อภาษาอังกฤษ (Name)**: Floating Market
...
- **อารยธรรม / ผู้นำเฉพาะ (Exclusive to)**: LOC_CIVILIZATION_SUK_SIAM_NAME (`TRAIT_CIVILIZATION_DISTRICT_SUK_FLOATINGMARKET`)
...
|---|---|---|---|---|
| Gold | `+2` | เขต Cothon | `DISTRICT_COTHON` | `Cothon_Gold` |
...
| Gold | `+2` | เขต Harbor | `DISTRICT_HARBOR` | `Harbor_Gold` |
| Gold | `+2` | ฟีเจอร์ Pamukkale | `FEATURE_PAMUKKALE` | `Pamukkale_Gold` |
| Gold | `+2` | แม่น้ำ (River Edge) | `RIVER` | `River_Gold` |
| Gold | `+2` | เขต Royal Navy Dockyard | `DISTRICT_ROYAL_NAVY_DOCKYARD` | `RoyalDock_Gold` |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Floating Market (DISTRICT_SUK_FLOATINGMARKET)
function IsValidPlotFor_DISTRICT_SUK_FLOATINGMARKET(pPlayer, pPlot, pCity)
