# Government Plaza (`DISTRICT_GOVERNMENT`)

> **คำอธิบายในเกม:**  
> A district placed once in your empire to commemorate your government choices. Provides +8 Loyalty per turn to this city, and an increase of +1 to the adjacency bonuses being earned by any adjacent district. Awards +1 [Icon_Governor] Governor Title.

---

## 1. ข้อมูลพื้นฐานและการปลดล็อก (Basic Information & Unlocking)

- **DistrictType**: `DISTRICT_GOVERNMENT`
- **ชื่อภาษาอังกฤษ (Name)**: Government Plaza
...
- **วัฒนธรรมที่ต้องการ (PrereqCivic)**: State Workforce (`CIVIC_STATE_WORKFORCE`)
- **ต้นทุนการผลิตพื้นฐาน (Base Production Cost)**: 30 [ICON_Production] (สเกลตามความก้าวหน้า Tech/Civic สูงสุดถึง x10)
...
| **MaxPerPlayer** | `1.0` | 1 แห่งทั้งอาณาจักร (National Unique / 1 per Empire) |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Government Plaza (DISTRICT_GOVERNMENT)
function IsValidPlotFor_DISTRICT_GOVERNMENT(pPlayer, pPlot, pCity)
