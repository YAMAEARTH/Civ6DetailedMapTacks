...
- **DistrictType**: `DISTRICT_SPACEPORT`
- **ชื่อภาษาอังกฤษ (Name)**: Spaceport
...
- **เทคโนโลยีที่ต้องการ (PrereqTech)**: Rocketry (`TECH_ROCKETRY`)
- **วัฒนธรรมที่ต้องการ (PrereqCivic)**: None (ไม่มี)
- **ต้นทุนการผลิตพื้นฐาน (Base Production Cost)**: 1800 [ICON_Production] (สเกลตามความก้าวหน้า Tech/Civic สูงสุดถึง x10)
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Spaceport (DISTRICT_SPACEPORT)
function IsValidPlotFor_DISTRICT_SPACEPORT(pPlayer, pPlot, pCity)
