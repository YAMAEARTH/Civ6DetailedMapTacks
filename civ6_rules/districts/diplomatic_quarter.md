# Diplomatic Quarter (`DISTRICT_DIPLOMATIC_QUARTER`)
...
- **ชื่อภาษาอังกฤษ (Name)**: Diplomatic Quarter
...
- **เทคโนโลยีที่ต้องการ (PrereqTech)**: Mathematics (`TECH_MATHEMATICS`)
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Diplomatic Quarter (DISTRICT_DIPLOMATIC_QUARTER)
function IsValidPlotFor_DISTRICT_DIPLOMATIC_QUARTER(pPlayer, pPlot, pCity)
