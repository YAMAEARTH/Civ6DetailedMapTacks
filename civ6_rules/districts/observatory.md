# Observatory (`DISTRICT_OBSERVATORY`)

> **คำอธิบายในเกม:**  
> A district unique to the Maya for scientific endeavors. Replaces the Campus district and cheaper to build.

+2 [ICON_Science] Science bonus for adjacent Plantations. +1 [ICON_Science] Science bonus for every two adjacent Farm or district tiles.

---

## 1. ข้อมูลพื้นฐานและการปลดล็อก (Basic Information & Unlocking)

- **DistrictType**: `DISTRICT_OBSERVATORY`
- **ชื่อภาษาอังกฤษ (Name)**: Observatory
...
- **อารยธรรม / ผู้นำเฉพาะ (Exclusive to)**: Maya (`TRAIT_CIVILIZATION_DISTRICT_OBSERVATORY`)
...
| Science | `+1 ต่อ 2 ช่อง` | สิ่งปรับปรุง Farm | `IMPROVEMENT_FARM` | `Farm_Science` |
...
| Science | `+2` | สิ่งปรับปรุง Plantation | `IMPROVEMENT_PLANTATION` | `Plantation_Science` |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Observatory (DISTRICT_OBSERVATORY)
function IsValidPlotFor_DISTRICT_OBSERVATORY(pPlayer, pPlot, pCity)
