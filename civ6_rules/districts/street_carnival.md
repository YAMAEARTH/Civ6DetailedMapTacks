...
- **ชื่อภาษาอังกฤษ (Name)**: Street Carnival
...
- **อารยธรรม / ผู้นำเฉพาะ (Exclusive to)**: Brazil (`TRAIT_CIVILIZATION_STREET_CARNIVAL`)
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Street Carnival (DISTRICT_STREET_CARNIVAL)
function IsValidPlotFor_DISTRICT_STREET_CARNIVAL(pPlayer, pPlot, pCity)
