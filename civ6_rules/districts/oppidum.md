...
+2 [ICON_Production] Production adjacency bonus from Quarries and strategic resources.

---

## 1. ข้อมูลพื้นฐานและการปลดล็อก (Basic Information & Unlocking)

- **DistrictType**: `DISTRICT_OPPIDUM`
- **ชื่อภาษาอังกฤษ (Name)**: Oppidum
...
- **อารยธรรม / ผู้นำเฉพาะ (Exclusive to)**: Gaul (`TRAIT_CIVILIZATION_DISTRICT_OPPIDUM`)
- **เทคโนโลยีที่ต้องการ (PrereqTech)**: Iron Working (`TECH_IRON_WORKING`)
...
| Production | `+2` | สิ่งปรับปรุง Quarry | `IMPROVEMENT_QUARRY` | `Quarry_Production2` |
| Production | `+2` | ทรัพยากรประเภท RESOURCECLASS_STRATEGIC | `RESOURCECLASS_STRATEGIC` | `Strategic_Production2` |
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Oppidum (DISTRICT_OPPIDUM)
function IsValidPlotFor_DISTRICT_OPPIDUM(pPlayer, pPlot, pCity)
