...
- **DistrictType**: `DISTRICT_ENCAMPMENT`
- **ชื่อภาษาอังกฤษ (Name)**: Encampment
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Encampment (DISTRICT_ENCAMPMENT)
function IsValidPlotFor_DISTRICT_ENCAMPMENT(pPlayer, pPlot, pCity)
