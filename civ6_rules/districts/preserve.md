# Preserve (`DISTRICT_PRESERVE`)

> **คำอธิบายในเกม:**  
> Grants up to 3 [ICON_Housing] Housing based on Appeal. Culture bombs adjacent neutral tiles, and increases their Appeal by 1.
...
- **วัฒนธรรมที่ต้องการ (PrereqCivic)**: Mysticism (`CIVIC_MYSTICISM`)
...
```lua
-- การตรวจสอบความถูกต้องสำหรับการวาง Preserve (DISTRICT_PRESERVE)
function IsValidPlotFor_DISTRICT_PRESERVE(pPlayer, pPlot, pCity)
